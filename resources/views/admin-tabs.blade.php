            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <ol class="breadcrumb" style="margin-bottom: 0px;padding-right: 0px;padding-top: 0px;padding-left: 82px;">
                        <li class="breadcrumb-item"><a type="button" onclick="window.history.back()">Find Users</a></li>
                                                                                            ...
                                                                                            <div class="col-md-4">
                                                                                                <div class="mb-3">
                                                                                                    ...
                                                                                                    padding-left: 20px;padding-bottom: 3px;font-size: 12px;"
                                                                                                            ...
                                                                                                            <option value="GAUTENG" style="font-size: 12px;"
                                                                                                                {{ isset($WorkProvince) && $WorkProvince == 'GAUTENG' ? 'selected' : '' }}>
                                                                                                                GAUTENG
                                                                                                            </option>
                                                                ...
                                                                placeholder="State Other">
                                                                                            ...
                                                                                            <div class="col-md-3">
                                                                                                <div class="mb-3">
                                                                                                    ...
                                                                                                    <label for="basicpill-vatno-input" class="font-weight-bold"
                                                                                                        style="font-size: 12px; color: rgb(0, 0, 0)">Nominee
                                                                                                        Declaration:</label>
