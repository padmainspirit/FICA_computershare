                ...
                <div class="col-md-3">
                    ...
                    <ol class="breadcrumb" style="margin-bottom: 0px;padding-right: 0px;padding-top: 0px;padding-left: 82px;">
                        ...
                        <li class="breadcrumb-item text-decoration-underline" style="font-weight: 500"><a
                                href="javascript: void(0);">Client Information</a></li>
                    </ol>
                            ...
                            <div class="card" style="width: 100%;">
                                <div class="card-body"
                                    ...
                                    <div class="form-floating mb-3">
                                        <img src="/images/results/client1.gif" alt="" height="100" width="100"
                                            class="auth-logo-light" style="display: block; margin: auto">
                                    </div>
                        ...
                        <div class="col-sm-2">
                            <div class="card" style="width: 100%;">
                                <div class="card-body"
                                    ...
                                    <div class="form-floating mb-3">
                                        <img src="/images/results/notes2.gif" alt="" height="100"
                                            width="100" class="auth-logo-light" style="display: block; margin: auto">
                                    </div>
                        ...
                        <div class="col-sm-2">
                            <div class="card" style="width: 100%;">
                                <div class="card-body"
                                    ...
                                    <div class="form-floating mb-3">
                                        <img src="/images/results/money3.gif" alt="" height="100"
                                            width="100" class="auth-logo-light" style="display: block; margin: auto">
                                    </div>
                        ...
                        <div class="col-sm-2">
                            <div class="card" style="width: 100%;">
                                <div class="card-body"
                                    ...
                                    <div class="form-floating mb-3">
                                        <img src="/images/results/facephone4.gif" alt="" height="100"
                                            width="100" class="auth-logo-light" style="display: block; margin: auto">
                                    </div>
                        ...
                        <div class="col-sm-2">
                            <div class="card" style="width: 100%;">
                                <div class="card-body"
                                    ...
                                    <div class="form-floating mb-3">
                                        <img src="/images/results/policy5.gif" alt="" height="100"
                                            width="100" class="auth-logo-light" style="display: block; margin: auto">
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                                ...
                                                <a class="nav-link mb-2" id="v-pills-kyc-tab" data-bs-toggle="pill"
                                                    href="#v-pills-kyc" role="tab" aria-controls="v-pills-kyc"
                                                    aria-selected="false">Know Your Customer (KYC)</a>
                                                <a class="nav-link mb-2" id="v-pills-banking-tab" data-bs-toggle="pill"
                                                    href="#v-pills-banking" role="tab"
                                                ...
                                                <a class="nav-link mb-2" id="v-pills-facialrecognition-tab"
                                                    ...
                                                    aria-selected="false">Facial Recognition</a>
                                                <a class="nav-link" id="v-pills-Compliance-tab" data-bs-toggle="pill"
                                                    href="#v-pills-Compliance" role="tab"
                                                    aria-controls="v-pills-Compliance"
                                                    aria-selected="false">Compliance</a>
                                            </div>

                                            <div class="row justify-content-center">
                                                <button type="button" id="newpdf" name="newpdf"
                                                    onclick="generate();"
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="tab-content text-muted mt-4 mt-md-0" id="v-pills-tabContent">
                                                ...
                                                <div class="tab-pane fade show active" id="v-pills-profile"
                                                    ...
                                                    <section>
                                                        ...
                                                        <div class="heading-fica-id">
                                                            <div class="text-left">
                                                                <h4
                                                                    style="color: #fff; padding-top:8px;padding-bottom: 8px;padding-left: 11px;">
                                                                    Personal Profile
                                                                </h4>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table table-hover mb-0"
                                                                        ...
                                                                        <thead
                                                                            ...
                                                                            <tr>
                                                                                <th class="col-md-4"
                                                                                    style="color:#ffffff;">KYC</th>
                                                                                <th class="col-md-7"
                                                                                    style="color:#ffffff;">Result</th>
                                                                                <th class="col-md-1"
                                                                                    style="color:#ffffff;padding-left: 0px;">
                                                                                    Pass/Fail</th>
                                                                            </tr>
                                                                        </thead>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    @if ($KYC_Status == 1)
                                                                                        ...
                                                                                        <p
                                                                                            style="color: green; text-transform: uppercase; display: none">
                                                                                            PASS</p>
                                                                                    @else
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table table-hover mb-0"
                                                                        ...
                                                                        <thead
                                                                            ...
                                                                            <tr>
                                                                                <th class="col-md-4"
                                                                                    style="color:#ffffff;">Bank Account
                                                                                    Details</th>
                                                                                <th class="col-md-7"
                                                                                    style="color:#ffffff;">Result</th>
                                                                                <th class="col-md-1"
                                                ...
                                                <div class="tab-pane fade" id="v-pills-facialrecognition" role="tabpanel"
                                                    aria-labelledby="v-pills-facialrecognition-tab">
                                                                                    ...
                                                                                    <table class="table mb-1"
                                                                                        ...
                                                                                        <thead
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <th
                                                                                                    style="color:#ffffff;padding-left: 110px;">
                                                                                                    Result
                                                                                                </th>
                                                                                            </tr>
                                                                                        </thead>
                                                                        ...
                                                                        <div id="collapseTwo"
                                                                            ...
                                                                            <div class="accordion-body">
                                                                                ...
                                                                                <div style="overflow: scroll;">
                                                                                    ...
                                                                                    <div
                                                                                        style="height:414px; overflow:auto;">

                                                                                        <table class="table mb-1"
                                                                                            id="downloadCompliance8">
                                                                                            ...
                                                                                            <thead>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <th class="table-light font-size-12 text-wrap"
                                                                                                        style="width:30%;">
                                                                                                        Comments
                                                                                                    </th>
                                                                                                </tr>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <input type="text" id="FirstName" name="FirstName"
                                                            class="form-control input-sm @error('FirstName') is-invalid @enderror"
                                                            value="{{ $FirstName }}"
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-group" style="height: 27px; width: 225px;">
                                                            ...
                                                            <input type="text" id="SURNAME" name="SURNAME"
                                                                class="form-control input-sm @error('SURNAME') is-invalid @enderror"
                                                                value="{{ $SURNAME }}"
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-group" style="height: 27px; width: 225px;">
                                                            ...
                                                            <input class="form-control" type="date" id="DOB"
                                                                name="DOB" value="{{ substr($DOB, 0, 10) }}"
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-group" style="height: 27px; width: 225px;">
                                                            ...
                                                            <input type="text" id="ID_CountryResidence"
                                                                ...
                                                                class="form-control input-sm @error('ID_CountryResidence') is-invalid @enderror"
                                                                style="height: 27px; width: 10px; font-size: 12px;
                                                                padding-left: 24px; text-transform: uppercase;"
                                                                placeholder="Enter The Country Issuer" required>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-group mb-3" style="height: 27px; width: 225px;">
                                                        ...
                                                        <input type="text" id="WorkTelephoneNo" name="WorkTelephoneNo"
                                                            class="form-control input-sm @error('WorkTelephoneNo') is-invalid @enderror" "
                                                                                                                                        value="{{ $WorkTelCode }}{{ $WorkTelNo }}"
                                                                                                                                        style="padding-left: 24px; height: 27px; font-size: 12px;
                                                             width: 225px; text-transform: uppercase;"
                                                                                                                                        placeholder="Enter Work Number" pattern="^\d{10}$" required>
                                                                                                                                ...
                                                                                                                                <div class="mb-3">
                                                                                                                                    <div class="input-group" style="height: 27px; width: 225px;">
                                                                                                                                        ...
                                                                                                                                        <input type="text" id="HomeTelephoneNo"
                                                                                                                                            name="HomeTelephoneNo" class="form-control input-sm @error('HomeTelephoneNo') is-invalid @enderror"
                                                                                                                                            value="{{ $HomeTelCode }}{{ $HomeTelNo }}"
                                                                                                                            ...
                                                                                                                            <div class="col-md-4">
                                                                                                                                <div class="input-group" style="height: 27px; width: 225px;">
                                                                                                                                    ...
                                                                                                                                    <input type="text" id="CellularNo" name="CellularNo"
                                                                                                                                        class="form-control input-sm @error('CellularNo') is-invalid @enderror"
                                                                                                                                        value="{{ $CellCode }}{{ $CellNo }}"
                                                                                                                                        style="height: 27px; padding-left: 24px; font-size: 12px;
                                                            text-transform: uppercase;"
                                                                                                                                        placeholder="Enter Cell Number" pattern="^\d{10}$" required>
                                                                                                                                    ...
                                                                                                                                    <div class="mb-3">
                                                                                                                                        <div class="input-group" style="height: 27px; width: 225px;">
                                                                                                                                            ...
                                                                                                                                            <input type="text" id="Nameofemployer"
                                                                                                                                                name="Nameofemployer" class="form-control input-sm"
                                                                                                                                ...
                                                                                                                                <div class="col-md-4">
                                                                                                                                    <div class="mb-3" style=" width: 225px; height: 27px;">
                                                                                                                                        ...
                                                                                                                                        <input type="text" id="Industryofoccupation"
                                                                                                                                            ...
                                                                                                                                            name="Industryofoccupation" class="form-control input-sm"
                                                                                                                                            style="height: 27px;; padding-left: 24px; font-size: 12px;
                                                                text-transform: uppercase;"
                                                                                                                ...
                                                                                                                <div class="row mb-3">
                                                                                                                    <div class="col-12">
                                                                                                                        <div class="row justify-content-center">
                                                                                                                            ...
                                                                                                                            <div class="col-lg-1">
                                                                                                                                <button type="submit" id="formsave1" class="btn btn-primary w-md"
                                                                                                                                    style="background-color: #5e7b00; border-color: #5e7b00">Save</button>
                                                                                                                            </div>

                                                                                                                            <div class="col-lg-1">
                                                                                                                                <button type="button" id="formedit1" class="btn btn-primary w-md"
                                                                                                                                    onclick="formEdit()"
                                                                                                                                    style="background-color: #93186c; border-color: #93186c">Edit</button>
                                                                                                                            </div>

                                                                                                                            <div class="col-lg-2">
                                                                                                                                <button type="button" id="formcancel1" class="btn btn-primary w-md"
                                                                                                                                    onclick="formCancel()"
                                                                                                                                    style="background-color: #93186c; border-color: #93186c">Cancel</button>
                                                                                                                            </div>
                                                        ...
                                                        style="font-size: 25px; margin-left: 25px;"></i>
                                                                                                                            ...
                                                                                                                            <div class="col-md-4">
                                                                                                                                <div class="mb-3" style=" width: 225px; height: 27px;">
                                                                                                                                    ...
                                                                                                                                    <input type="text" id="OriginalAddress1"
                                                                                                                                        ...
                                                                                                                                        placeholder="Enter Street Address Line 1" required>
                                                                                                      ...
                                                                                                      padding-left: 20px;padding-bottom: 3px;font-size: 12px;"
                                                                                                                                            ...
                                                                                                                                            <option value="FREE STATE" style="font-size: 12px;"
                                                                                                                                                {{ Str::upper(isset($ResProvince)) && Str::upper($ResProvince) == 'FREE STATE' ? 'selected' : '' }}>
                                                                                                                                                FREE STATE
                                                                                                                                            </option>

                                                                                                                                            <option value="KWAZULU-NATAL" style="font-size: 12px;"
                                                                                                                                                {{ Str::upper(isset($ResProvince)) && Str::upper($ResProvince) == 'KWAZULU-NATAL' ? 'selected' : '' }}>
                                                                                                                                                KWAZULU-NATAL
                                                                                                                                            </option>

                                                                                                                                            <option value="GAUTENG" style="font-size: 12px;"
                                                                                                                                                {{ Str::upper(isset($ResProvince)) && Str::upper($ResProvince) == 'GAUTENG' ? 'selected' : '' }}>
                                                                                                                                                GAUTENG
                                                                                                                                            </option>

                                                                                                                                            <option value="LIMPOPO" style="font-size: 12px;"
                                                                                                                                                {{ Str::upper(isset($ResProvince)) && Str::upper($ResProvince) == 'LIMPOPO' ? 'selected' : '' }}>
                                                                                                                                                LIMPOPO
                                                                                                                                            </option>

                                                                                                                                            <option value="MPUMALANGA" style="font-size: 12px;"
                                                                                                                                                {{ Str::upper(isset($ResProvince)) && Str::upper($ResProvince) == 'MPUMALANGA' ? 'selected' : '' }}>
                                                                                                                                                MPUMALANGA
                                                                                                                                            </option>

                                                                                                                                            <option value="NORTH WEST" style="font-size: 12px;"
                                                                                                                                                {{ Str::upper(isset($ResProvince)) && Str::upper($ResProvince) == 'NORTH WEST' ? 'selected' : '' }}>
                                                                                                                                                NORTH WEST
                                                                                                                                            </option>

                                                                                                                                            <option value="NORTHERN CAPE" style="font-size: 12px;"
                                                                                                                                                {{ Str::upper(isset($ResProvince)) && Str::upper($ResProvince) == 'NORTHERN CAPE' ? 'selected' : '' }}>
                                                                                                                                                NORTHERN CAPE
                                                                                                                                            </option>

                                                                                                                                            <option value="WESTERN CAPE" style="font-size: 12px;"
                                                                                                                                                {{ Str::upper(isset($ResProvince)) && Str::upper($ResProvince) == 'WESTERN CAPE' ? 'selected' : '' }}>
                                                                                                                                                WESTERN CAPE
                                                                                                                                            </option>
                                                                                                                                ...
                                                                                                                                <div class="mb-3">
                                                                                                                                    <div class="input-group" style="height: 27px; width: 225px;">
                                                                                                                                        <select class="form-select" autocomplete="off"
                                                                                                                                            style="height: 27px;padding-top: 3px; text-transform: uppercase;
                                                                                                    padding-left: 20px;padding-bottom: 3px;font-size: 12px;"
                                                                                                                                            id="PostProvince" name="PostProvince">
                                                                                                                                            <option selected
                                                                                                                                                style="text-transform: uppercase;font-size: 12px;"
                                                                                                                                                disabled>
                                                                                                                                                Select
                                                                                                                                            ...
                                                                                                                                            <option value="EASTERN CAPE" style="font-size: 12px;"
                                                                                                                                                {{ Str::upper(isset($PostProvince)) && Str::upper($PostProvince) == 'EASTERN CAPE' ? 'selected' : '' }}>
                                                                                                                                                EASTERN CAPE
                                                                                                                                            </option>

                                                                                                                                            <option value="FREE STATE" style="font-size: 12px;"
                                                                                                                                                {{ Str::upper(isset($PostProvince)) && Str::upper($PostProvince) == 'FREE STATE' ? 'selected' : '' }}>
                                                                                                                                                FREE STATE
                                                                                                                                            </option>

                                                                                                                                            <option value="KWAZULU-NATAL" style="font-size: 12px;"
                                                                                                                                                {{ Str::upper(isset($PostProvince)) && Str::upper($PostProvince) == 'KWAZULU-NATAL' ? 'selected' : '' }}>
                                                                                                                                                KWAZULU-NATAL
                                                                                                                                            </option>

                                                                                                                                            <option value="GAUTENG" style="font-size: 12px;"
                                                                                                                                                {{ Str::upper(isset($PostProvince)) && Str::upper($PostProvince) == 'GAUTENG' ? 'selected' : '' }}>
                                                                                                                                                GAUTENG
                                                                                                                                            </option>

                                                                                                                                            <option value="LIMPOPO" style="font-size: 12px;"
                                                                                                                                                {{ Str::upper(isset($PostProvince)) && Str::upper($PostProvince) == 'LIMPOPO' ? 'selected' : '' }}>
                                                                                                                                                LIMPOPO
                                                                                                                                            </option>

                                                                                                                                            <option value="MPUMALANGA" style="font-size: 12px;"
                                                                                                                                                {{ Str::upper(isset($PostProvince)) && Str::upper($PostProvince) == 'MPUMALANGA' ? 'selected' : '' }}>
                                                                                                                                                MPUMALANGA
                                                                                                                                            </option>

                                                                                                                                            <option value="NORTH WEST" style="font-size: 12px;"
                                                                                                                                                {{ Str::upper(isset($PostProvince)) && Str::upper($PostProvince) == 'NORTH WEST' ? 'selected' : '' }}>
                                                                                                                                                NORTH WEST
                                                                                                                                            </option>

                                                                                                                                            <option value="NORTHERN CAPE" style="font-size: 12px;"
                                                                                                                                                {{ Str::upper(isset($PostProvince)) && Str::upper($PostProvince) == 'NORTHERN CAPE' ? 'selected' : '' }}>
                                                                                                                                                NORTHERN CAPE
                                                                                                                                            </option>

                                                                                                                                            <option value="WESTERN CAPE" style="font-size: 12px;"
                                                                                                                                                {{ Str::upper(isset($PostProvince)) && Str::upper($PostProvince) == 'WESTERN CAPE' ? 'selected' : '' }}>
                                                                                                                                                WESTERN CAPE
                                                                                                                                            </option>
                                                                                                                            ...
                                                                                                                            <div class="col-md-4">
                                                                                                                                <div class="mb-3" style=" width: 225px; height: 27px;">
                                                                                                                                    ...
                                                                                                                                    <input type="text" id="PostOriginalPostalCode"
                                                                                                                                        name="PostOriginalPostalCode" pattern="^[0-9]*$"
                                                                                                                                ...
                                                                                                                                <div class="mb-3">
                                                                                                                                    <div class="input-group" style="height: 27px; width: 225px;">
                                                                                                                                        <select class="form-select" autocomplete="off"
                                                                                                                                            style="height: 27px;padding-top: 3px; text-transform: uppercase;
                                                                                                                padding-left: 20px;padding-bottom: 3px;font-size: 12px;"
                                                                                                                                            id="WorkProvince" name="WorkProvince">
                                                                                                                                            <option selected
                                                                                                                                                style="text-transform: uppercase;font-size: 12px;"
                                                                                                                                                disabled>
                                                                                                                                                Select
                                                                                                                                            ...
                                                                                                                                            <option value="EASTERN CAPE" style="font-size: 12px;"
                                                                                                                                                {{ Str::upper(isset($WorkProvince)) && Str::upper($WorkProvince) == 'EASTERN CAPE' ? 'selected' : '' }}>
                                                                                                                                                EASTERN CAPE
                                                                                                                                            </option>

                                                                                                                                            <option value="FREE STATE" style="font-size: 12px;"
                                                                                                                                                {{ Str::upper(isset($WorkProvince)) && Str::upper($WorkProvince) == 'FREE STATE' ? 'selected' : '' }}>
                                                                                                                                                FREE STATE
                                                                                                                                            </option>

                                                                                                                                            <option value="KWAZULU-NATAL" style="font-size: 12px;"
                                                                                                                                                {{ Str::upper(isset($WorkProvince)) && Str::upper($WorkProvince) == 'KWAZULU-NATAL' ? 'selected' : '' }}>
                                                                                                                                                KWAZULU-NATAL
                                                                                                                                            </option>

                                                                                                                                            <option value="GAUTENG" style="font-size: 12px;"
                                                                                                                                                {{ Str::upper(isset($WorkProvince)) && Str::upper($WorkProvince) == 'GAUTENG' ? 'selected' : '' }}>
                                                                                                                                                GAUTENG
                                                                                                                                            </option>

                                                                                                                                            <option value="LIMPOPO" style="font-size: 12px;"
                                                                                                                                                {{ Str::upper(isset($WorkProvince)) && Str::upper($WorkProvince) == 'LIMPOPO' ? 'selected' : '' }}>
                                                                                                                                                LIMPOPO
                                                                                                                                            </option>

                                                                                                                                            <option value="MPUMALANGA" style="font-size: 12px;"
                                                                                                                                                {{ Str::upper(isset($WorkProvince)) && Str::upper($WorkProvince) == 'MPUMALANGA' ? 'selected' : '' }}>
                                                                                                                                                MPUMALANGA
                                                                                                                                            </option>

                                                                                                                                            <option value="NORTH WEST" style="font-size: 12px;"
                                                                                                                                                {{ Str::upper(isset($WorkProvince)) && Str::upper($WorkProvince) == 'NORTH WEST' ? 'selected' : '' }}>
                                                                                                                                                NORTH WEST
                                                                                                                                            </option>

                                                                                                                                            <option value="NORTHERN CAPE" style="font-size: 12px;"
                                                                                                                                                {{ Str::upper(isset($WorkProvince)) && Str::upper($WorkProvince) == 'NORTHERN CAPE' ? 'selected' : '' }}>
                                                                                                                                                NORTHERN CAPE
                                                                                                                                            </option>

                                                                                                                                            <option value="WESTERN CAPE" style="font-size: 12px;"
                                                                                                                                                {{ Str::upper(isset($WorkProvince)) && Str::upper($WorkProvince) == 'WESTERN CAPE' ? 'selected' : '' }}>
                                                                                                                                                WESTERN CAPE
                                                                                                                                            </option>
                                                                                                                            ...
                                                                                                                            <div class="col-md-4">
                                                                                                                                <div class="mb-3" style=" width: 225px; height: 27px;">
                                                                                                                                    ...
                                                                                                                                    <input type="text" id="WorkOriginalPostalCode"
                                                                                                                                        name="WorkOriginalPostalCode" pattern="^[0-9]*$"
                                                                                                                ...
                                                                                                                <div class="row mb-3">
                                                                                                                    <div class="col-12">
                                                                                                                        <div class="row justify-content-center">
                                                                                                                            ...
                                                                                                                            <div class="col-lg-1">
                                                                                                                                <button type="submit" id="formsave2" class="btn btn-primary w-md"
                                                                                                                                    style="background-color: #5e7b00; border-color: #5e7b00">Save</button>
                                                                                                                            </div>

                                                                                                                            <div class="col-lg-1">
                                                                                                                                <button type="button" id="formedit2" class="btn btn-primary w-md"
                                                                                                                                    onclick="formEdit()"
                                                                                                                                    style="background-color: #93186c; border-color: #93186c">Edit</button>
                                                                                                                            </div>
                                                                                                                            ...
                                                                                                                            <div class="col-md-4">
                                                                                                                                <div class="mb-3" style=" width: 225px; height: 27px;">
                                                                                                                                    ...
                                                                                                                                    <input type="text" id="Branch_code" name="Branch_code"
                                                                                                                                        class="form-control input-sm" value="{{ $Branch_code }}"
                                                                                                                                        style="height: 27px; padding-left: 24px; text-transform: uppercase;font-size: 12px;"
                                                                                                                                        placeholder="Enter Your Bank Code" pattern="^[0-9]*$">
                                                                                                                            ...
                                                                                                                            <div class="col-md-4">
                                                                                                                                <div class="mb-3" style=" width: 225px; height: 27px;">
                                                                                                                                    ...
                                                                                                                                    <input type="text" id="AccountName" name="AccountName"
                                                                                                                                        class="form-control input-sm" value="{{ $Account_name }}"
                                                                                                                                        style="height: 27px; padding-left: 24px; text-transform: uppercase;font-size: 12px;"
                                                                                                                                        placeholder="Enter Your Account Surname" required>
                                                                                                                            ...
                                                                                                                            <div class="col-md-4">
                                                                                                                                <div class="mb-3" style=" width: 225px; height: 27px;">
                                                                                                                                    ...
                                                                                                                                    <input type="text" id="INITIALS" name="INITIALS"
                                                                                                                                        ...
                                                                                                                                        style="height: 27px; padding-left: 24px; text-transform: uppercase;font-size: 12px;"
                                                                                                                                        placeholder="Enter Your Account Initials">
                                                                                                                            ...
                                                                                                                            <div class="col-md-4">
                                                                                                                                <div class="mb-3" style=" width: 225px; height: 27px;">
                                                                                                                                    ...
                                                                                                                                    <input type="text" id="Tax_Number" name="Tax_Number"
                                                                                                                                        class="form-control input-sm" value="{{ $Tax_Number }}"
                                                                                                                                        style="height: 27px; padding-left: 24px; text-transform: uppercase;font-size: 12px;"
                                                                                                                    ...
                                                                                                                    <div class="row d-flex justify-content-center">
                                                                                                                        ...
                                                                                                                        <div class="col-lg-6">
                                                                                                                            ...
                                                                                                                            <div class="mb-3">
                                                                                                                                ...
                                                                                                                                <select class="form-select"
                                                                                                                                    style="height: 27px;padding-top: 3px;padding-left: 20px;padding-bottom: 3px;font-size: 12px;"
                                                                                                                                    name="Public_official_Family" id="Public_official_Family"
                                                                                                                                    required>
                                                                                                                                    <option selected disabled>Select</option>
                                                                                                                                    <option value=1
                                                                                                                            ...
                                                                                                                            <div class="col-lg-6">
                                                                                                                                <div class="mb-3">
                                                                                                                                    ...
                                                                                                                                    <select class="form-select"
                                                                                                                                        ...
                                                                                                                                        <option selected disabled>Select</option>
                                                                                                                                        <option value=1
                                                                                                                                            {{ isset($SanctionList) && $SanctionList == 1 ? 'selected' : '' }}>
                                                                                                                                            YES</option>
                                                                                                                                        <option value=0
                                                                                                                                            {{ isset($SanctionList) && $SanctionList == 0 ? 'selected' : '' }}>
                                                                                                                                            NO</option>
                                                                                                                                    </select>
                                                                                                                    ...
                                                                                                                    <div class="col-12">
                                                                                                                        <div class="row justify-content-center">
                                                                                                                            ...
                                                                                                                            <div class="col-lg-2 mb-2">
                                                                                                                                <button type="button" id="formcancel3"
                                                                                                                                    class="btn btn-primary w-md" onclick="formCancel()"
                                                                                                                                    style="background-color: #93186c; border-color: #93186c">Cancel</button>
                                                                                                                            </div>
                                                                                                                            ...
                                                                                                                            <div class="col-md-4">
                                                                                                                                <div class="mb-3">
                                                                                                                                    ...
                                                                                                                                    <select class="form-select" autocomplete="off"
                                                                                                                                        ...
                                                                                                                                        <option
                                                                                                                                            value="Ongoing trading (Estimated value between R1 to R50 000)"
                                                                                                                                            style="font-size: 12px;"
                                                                                                                                ...
                                                                                                                                <div class="mb-3">
                                                                                                                                    ...
                                                                                                                                    <select class="form-select" autocomplete="off"
                                                                                                                                        ...
                                                                                                                                        <option
                                                                                                                                            value='YES'
                                                                                                                                            style="font-size: 12px;"
                                                                                                                                            {{ isset($NomineeDeclaration) && $NomineeDeclaration == 'YES' ? 'selected' : '' }}>
                                                                                                                            ...
                                                                                                                            <div class="col-md-4">
                                                                                                                                <div class="mb-3">
                                                                                                                                    ...
                                                                                                                                    <select class="form-select" autocomplete="off"
                                                                                                                                        ...
                                                                                                                                        <option value="I do not wish to receive an report"
                                                                                                                                            style="font-size: 12px;"
                                                                                                                                        ...
                                                                                                                                        <option value="Summary financial statement for Securities"
                                                                                                                                            style="font-size: 12px;"
                                                                                                                            ...
                                                                                                                            <div class="col-md-4">
                                                                                                                                ...
                                                                                                                                <div class="mb-3">
                                                                                                                                    ...
                                                                                                                                    <select class="form-select" autocomplete="off"
                                                                                                                                        ...
                                                                                                                                        <option value="Securities held on my behalf must be register"
                                                                                                                                            style="font-size: 12px;"
                                                                                                                        ...
                                                                                                                        <div class="row">
                                                                                                                            ...
                                                                                                                            <div class="col-md-4">
                                                                                                                                <div class="mb-3">
                                                                                                                                    ...
                                                                                                                                    <input type="text" id="Broker" name="Broker"
                                                                                                                                        class="form-control input-sm" value="{{ $Broker }}"
                                                                                                                                        style="height: 27px;width:225px;padding-bottom: 3px;padding-top: 3px;font-size: 12px;"
                                                                                                                            ...
                                                                                                                            <div class="col-md-3">
                                                                                                                                <div class="mb-3">
                                                                                                                                    ...
                                                                                                                                    <label for="basicpill-vatno-input" class="font-weight-bold"
                                                                                                                                        style="font-size: 12px; color: rgb(0, 0, 0)">Broker
                                                                                                                                        Communication:</label>
                                                                                                                            ...
                                                                                                                            <div class="col-md-1">
                                                                                                                                <div class="mb-3">
                                                                                                                                    ...
                                                                                                                                    <input type="text" id="BrokerContact" name="BrokerContact"
                                                                                                                                        class="form-control input-sm" value="{{ $BrokerContact }}"
                                                                                                                                        style="height: 27px;width:225px;padding-bottom: 3px;padding-top: 3px;font-size: 12px;"
                                                                                                                ...
                                                                                                                <div class="row mb-3">
                                                                                                                    <div class="col-12">
                                                                                                                        ...
                                                                                                                        <div class="row justify-content-center">
                                                                                                                            ...
                                                                                                                            <div class="col-lg-1">
                                                                                                                                <button type="submit" id="formsave4" class="btn btn-primary w-md"
                                                                                                                                    style="background-color: #5e7b00; border-color: #5e7b00">Save</button>
                                                                                                                            </div>

                                                                                                                            <div class="col-lg-1">
                                                                                                                                <button type="button" id="formedit4" class="btn btn-primary w-md"
                                                                                                                                    onclick="formEdit()"
                                                                                                                                    style="background-color: #93186c; border-color: #93186c">Edit</button>
                                                                                                                            </div>
