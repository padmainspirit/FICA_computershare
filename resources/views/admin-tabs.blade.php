                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-group" style="height: 27px; width: 225px;">
                                                            ...
                                                            <select class="form-select" autocomplete="off"
                                                                ...
                                                                text-transform: uppercase; font-size: 11px;"
                                                                id="Gender" name="Gender" aria-placeholder="Select" required>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-group" style="height: 27px; width: 225px;">
                                                            ...
                                                            <input type="text" id="HomeTelephoneNo"
                                                                ...
                                                                text-transform: uppercase;"
                                                                placeholder="Enter Home Number" pattern="^\d{10}$" required>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3" style=" width: 225px; height: 27px;">
                                                        ...
                                                        <input type="text" id="Account_no" name="Account_no"
                                                            ...
                                                            style="height: 27px; padding-left: 24px; text-transform: uppercase;font-size: 12px;"
                                                            placeholder="Enter Your Account Number" pattern="^[0-9]*$" required>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3" style=" width: 225px; height: 27px;">
                                                        ...
                                                        <input type="text" id="Tax_Number" name="Tax_Number"
                                                            ...
                                                            value="{{ $Tax_Number }}"
                                                            style="height: 27px; padding-left: 24px; text-transform: uppercase;font-size: 12px;"
                                                            placeholder="Enter Your Income Tax Number" pattern="^[0-9]*$" required>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3" style=" width: 225px; height: 27px;">
                                                        ...
                                                        <input type="text" id="Foreign_Tax_Number"
                                                            ...
                                                            style="height: 27px; padding-left: 24px; text-transform: uppercase;font-size: 12px;"
                                                            placeholder="Enter Your Foreign Tax Number" pattern="^[0-9]*$">
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            value == 'Securities must be registered in my own name and maintained by ComputerShare' s Deal Routing Service' ? $("#newoptions1").hide() : $("#newoptions1").show();
