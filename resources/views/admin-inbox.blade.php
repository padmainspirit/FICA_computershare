                                            ...
                                            <div class="table-responsive" style="margin-left: 14px;">
                                                <table class="table table-sm mb-0 w-auto h-auto" style="height: 480px;">
                                                    ...
                                                    <thead style="background-color: #93186c;border-bottom-color: #93186c">
                                                        <tr hei>
                                                            <th class="col-md-3 font-size-12" style="color:#ffffff;">From
                                                                Email</th>
                                                            <th class="col-md-3 font-size-12" style="color:#ffffff;">To
                                                                Email</th>
                                                            <th class="col-md-4 font-size-12" style="color:#ffffff;">Message
                                                            </th>
                                                            <th class="col-md-1 font-size-12" style="color:#ffffff;">Sent At
                                                            </th>
                                                        </tr>
                                                    </thead>
