    ...
    <table role="presentation" bgcolor="#93186c" border="0" width="75%" cellspacing="0">
        ...
        <tr>
            <td bgcolor="#93186c" align="left" style="color: white; padding: 20px 20px 20px 20px;">
                <h1 style="font-size: 20px;font-family:Arial,sans-serif;">One Time Password (OTP)</h1>
            </td>
        </tr>
    </table>
        ...
        <tr>
            <td style="padding: 30px 30px 30px 30px;color:#696969;">
                <p style="margin:0 0 12px 0;font-size:14px;line-height:16px;font-family:Arial,sans-serif;">Below is your
                    one-time password (OTP) verification, which will be valid for the next 5 minutes to login to your
                    account if you have not received an SMS.</p>
                <br>
                <p style="margin:0 0 12px 0;font-size:14px;line-height:16px;font-family:Arial,sans-serif;">CODE: <span
                        style="color: #5e7b00;font-weight:bold">{{ $otp }}</span></p>
                <br>
