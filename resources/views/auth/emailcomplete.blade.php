  ...
  <table role="presentation" border="0" width="75%" cellspacing="0">
      <tr>
          <td style="padding: 30px 30px 30px 30px;color:#696969;">
            ...
            <p style="margin:0 0 12px 0;font-size:14px;line-height:16px;font-family:Arial,sans-serif;">Thank you for registering and successfully completing the electronic FICA verification process. We’re now in the process of creating your account. Once this has been set up, we’ll send you your account information so you can start growing your investor portfolio.
            </p>
            <p></p>
            <p></p>
