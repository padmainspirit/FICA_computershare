...
! function (a, b) {
    ...
    function w(b) {
        ...
        var currentstep = document.getElementById('progressStep').innerHTML;
        console.log(currentstep);
        c.startIndex = parseInt(currentstep) > 9 ? 9 : parseInt(currentstep);
    ...
    function J(b, c, d) {
        var e = '<{0} class="{1}">{2}</{0}>',
            ...
            i = a(e.format(c.stepsContainerTag, "steps " + c.clearFixCssClass, '<ul role="tablist" style="margin-top: 12px; " ></ul>')),
    ...
    function L(a, b, c) {
        if (b.enablePagination) {
            var d = '<{0} class="actions {1}" style="display:none"><ul role="menu" aria-label="{2}">{3}</ul></{0}>',
                // var d = '<{0} class="actions {1}"><ul role="menu" aria-label="{2}">{3}</ul></{0}>',
                e = '<li><a href="#{0}" role="menuitem" style="padding-left: 30px;padding-right: 30px;" id=previous-btn>{1} </a></li>',
                e1 = '<li><a href="#{0}" role="menuitem" style="padding-left: 45px;padding-right: 45px;">{1}</a></li>',
                e2 = '<li><a href="#{0}" role="menuitem" style="padding-left: 40px;padding-right: 40px;">{1}</a></li>',
                f = "";
            b.forceMoveForward || (f += e.format("previous", b.labels.previous)), f += e1.format("next", b.labels.next), b.enableFinishButton && (f += e.format("finish", b.labels.finish)), b.enableCancelButton && (f += e1.format("cancel", b.labels.cancel)), a.append(d.format(b.actionContainerTag, b.clearFixCssClass, b.labels.pagination, f)), D(a, b, c), A(a, b, c)
        }
    }
